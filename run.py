...
status = ['🦋 𝕯𝖔𝖜𝖔𝖗𝖓𝖊𝖑𝖑𝖊𝖘 🦋 assistant', 'Um mosquitinho', 'Seulgi queue, Seulgi play']
queue = []
...
async def change_status():
    await client.change_presence(activity=discord.Activity(type=discord.ActivityType.listening, name=choice(status)))
